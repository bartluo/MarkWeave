  ...
  const submenu: MenuItemConstructorOptions[] = [
    {
      ...
      click() {
        shell.openExternal(
          'https://markweave.me/docs/markdown-syntax'
        )
      }
    },
    {
    ...
    },
    {
      ...
      click() {
        shell.openExternal('https://twitter.com/markweaveapp')
      }
    },
    {
      label: t('menu.help.support'),
      click() {
        shell.openExternal('https://github.com/sponsors/markweave')
      }
    },
    {
      type: 'separator'
    },
    {
      ...
      click() {
        shell.openExternal('https://github.com/markweave/markweave/discussions')
      }
    },
    {
    ...
    },
    {
      ...
      click() {
        shell.openExternal('https://github.com/markweave/markweave')
      }
    },
    {
      type: 'separator'
    },
    {
      ...
      click() {
        shell.openExternal('https://github.com/markweave/markweave/blob/develop/LICENSE')
      }
    }
  ]
