...
The easiest way to build MarkWeave on Linux is from inside a container.
...
3. Build MarkWeave binaries and packages: `pnpm run build`
4. MarkWeave binary is located under `dist` folder (electron-builder output)
...
| Script  | Description                                      |
| ------- | ------------------------------------------------ |
| `build` | Build MarkWeave binaries and packages for your OS |
| `dev`   | Build and run MarkWeave in developer mode         |
