    ...
    groups: [
      {
        ...
        pages: [
          ...
          { slug: ['markdown-syntax'], title: 'Markdown syntax', file: 'end-user/MARKDOWN_SYNTAX.md', hint: 'Every element MarkWeave renders' }
        ]
      },
      {
        label: 'Configuration',
        pages: [
          ...
          { slug: ['application-data-directory'], title: 'Application data directory', file: 'end-user/APPLICATION_DATA_DIRECTORY.md', hint: 'Where MarkWeave stores user data' },
      ...
      },
      {
        label: 'More',
        pages: [
          { slug: ['portable'], title: 'Portable mode', file: 'end-user/PORTABLE.md', hint: 'Run MarkWeave from a USB stick' },
    ...
    groups: [
      {
        ...
        pages: [
          ...
          { slug: ['dev', 'build'], title: 'Build instructions', file: 'dev/BUILD.md', hint: 'Build MarkWeave from source' },
