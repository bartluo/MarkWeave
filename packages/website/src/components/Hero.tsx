      ...
      <div className="wrap">
        ...
        <div className={revealClass('d2', 'stage')} id="stage" ref={stageRef}>
          ...
          <MockWindow title="product-launch.md" showActions windowId="heroWin" windowRef={winRef}>
            ...
            <p className="lead">
              MarkWeave renders your formatting <strong>as you type</strong> — headings grow, <em>emphasis</em> leans, and{' '}
            ...
            <blockquote>“The best Markdown editors disappear. MarkWeave disappears beautifully.”</blockquote>
            <pre>
